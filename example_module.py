...
if __name__ == "__main__":
    ...
    # Load data from file
    context, events, labels, mapping = preprocessor.csv('/Users/liguangyu/Downloads/DeepCASE-main-2/attack_data_num2.csv')
    ...
    prediction_train = deepcase.fit_predict(
        ...
        iterations       = 10,               # Number of iterations to use for attention query, in paper this was 100
